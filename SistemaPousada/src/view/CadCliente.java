...
public class CadCliente extends javax.swing.JDialog {
    ...
    public CadCliente(java.awt.Frame parent, boolean modal) {
        ...
        jTableCliente.setModel(clienteDAO.carregarTabela("T",""));
        jTableCliente.setDefaultEditor(Object.class, null);
    ...
    private void initComponents() {
        ...
        jLabelCodigoClienteConsulta = new javax.swing.JLabel();
        jTextFieldCodigoClienteConsulta = new javax.swing.JTextField();
        ...
        jLabelCodigoClienteConsulta.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabelCodigoClienteConsulta.setText("Código do Cliente:");

        jTextFieldCodigoClienteConsulta.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jTextFieldCodigoClienteConsulta.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTextFieldCodigoClienteConsultaKeyPressed(evt);
            }
        });
        ...
        jScrollPaneTabelaCliente.setViewportView(jTableCliente);
        ...
        jPanelConsultaLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelConsultaLayout.createSequentialGroup()
                ...
                .addGroup(jPanelConsultaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPaneTabelaCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 540, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanelConsultaLayout.createSequentialGroup()
                        .addComponent(jLabelCodigoClienteConsulta)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jTextFieldCodigoClienteConsulta, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanelConsultaLayout.setVerticalGroup(
            ...
            .addGroup(jPanelConsultaLayout.createSequentialGroup()
                ...
                .addGroup(jPanelConsultaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelCodigoClienteConsulta)
                    .addComponent(jTextFieldCodigoClienteConsulta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneTabelaCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addGroup(jPanelCamposLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelCamposLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelCamposLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextFieldEnderecoCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 354, Short.MAX_VALUE))
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(jLabelGravacao, javax.swing.GroupLayout.DEFAULT_SIZE, 407, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        if (SysUtil.confirmDialog("Deseja excluir esse registro?", "Atenção")) {
          clienteDAO.excluirClietne(clienteConsulta);
          EventoBotoes.inicio(jPanelBotoes.getComponents(), jPanelStatus.getComponents());
          SysUtil.trocaPanels(jPanelMeio, jPanelConsulta);
          jLabelConsulta.setText("Registro excluído com sucesso !");
          limpaCampos();
        }
        jTableCliente.setModel(clienteDAO.carregarTabela("T",jTextFieldCodigoClienteConsulta.getText()));
    ...
    private void jButtonGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGravarActionPerformed
        ...
        if(SysUtil.isEmpty(jPanelCampos.getComponents())) {
            if(jLabelStatus.getText().equals("Inserindo")) {
              clienteDAO.inserirCliente(new Cliente(jTextFieldNomeCliente.getText(),
                                                    jTextFieldEnderecoCliente.getText()));
            }else if (jLabelStatus.getText().equals("Editando")) {
              clienteDAO.alterarCliente(clienteConsulta, new Cliente(jTextFieldNomeCliente.getText(),
                                                            jTextFieldEnderecoCliente.getText()));
            }
            EventoBotoes.inicio(jPanelBotoes.getComponents(), jPanelStatus.getComponents());
            SysUtil.trocaPanels(jPanelMeio, jPanelConsulta);
    ...
    private void jTextFieldCodigoClienteConsultaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCodigoClienteConsultaKeyPressed

        if(!jTextFieldCodigoClienteConsulta.getText().isEmpty()) {
            jTableCliente.setModel(clienteDAO.carregarTabela("F",jTextFieldCodigoClienteConsulta.getText()));
        } else if(jTextFieldCodigoClienteConsulta.getText().isEmpty()) {
            jTableCliente.setModel(clienteDAO.carregarTabela("T",jTextFieldCodigoClienteConsulta.getText()));
        }

    }//GEN-LAST:event_jTextFieldCodigoClienteConsultaKeyPressed

    private void jTableClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableClienteMouseClicked
        
        if(evt.getClickCount() == 2 ) {

            clienteConsulta = clienteDAO.consultarCliente(jTableCliente.getValueAt(jTableCliente.getSelectedRow(), 1).toString());
            jTextFieldNomeCliente.setText(clienteConsulta.getNome());
            jTextFieldEnderecoCliente.setText(clienteConsulta.getEndereco());
    ...
    private javax.swing.JLabel jLabelCodigoClienteConsulta;
    ...
    private javax.swing.JTextField jTextFieldCodigoClienteConsulta;
    private javax.swing.JTextField jTextFieldEnderecoCliente;
    private javax.swing.JTextField jTextFieldNomeCliente;
    // End of variables declaration//GEN-END:variables

    private void limpaCampos() {
        jTextFieldCodigoClienteConsulta.setText("");
